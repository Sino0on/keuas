...
class Folder(models.Model):
    on_page = models.BooleanField(default=False, blank=True, null=True)
    user = models.ForeignKey(User, on_delete=models.CASCADE, blank=True, null=True)
    folder = models.ForeignKey('Folder', related_name='folders', on_delete=models.CASCADE, blank=True, null=True)
